...
> This subfolder is forked and modified from the [Azure Samples ms-identity-javascript-react-tutorial](https://github.com/Azure-Samples/ms-identity-javascript-react-tutorial) the below content is unmodified from the original repository.
